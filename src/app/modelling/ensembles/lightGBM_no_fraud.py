...
from src.app.antifraud.antifraud import delete_fraud
...
def main_lightgbm_optuna(path):
    data = pd.read_csv(f'{path}/data_prep_train_test.csv')
    data = delete_fraud(data)
    ...
    joblib.dump(best_lightgbm, f'{path}/lightgbm_optuna_model_no_fraud.pkl')

path = '/Users/vi/home-credit-default-risk/modelling'
main_lightgbm_optuna(path)
